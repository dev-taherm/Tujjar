    ...
    <>
      ...
      {!customers?.length ? (
        <div className="flex flex-col items-center justify-center rounded-xl border-2 border-dashed border-gray-300 py-16">
          ...
          <h3 className="mb-2 text-lg font-medium text-gray-900">No customers yet</h3>
          <p className="text-sm text-gray-500">Customer data will appear as orders are placed.</p>
        </div>
      ) : (
