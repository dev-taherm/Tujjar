          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <div className="flex gap-2">
                <Button variant="outline" size="sm" onClick={() => setShipShow(!shipShow)}><Truck className="mr-1 h-4 w-4" /> Ship</Button>
                <Button variant="outline" size="sm" onClick={() => deliverOrder.mutateAsync(orderId)}><CheckCircle className="mr-1 h-4 w-4" /> Deliver</Button>
                <Button variant="outline" size="sm" onClick={() => cancelOrder.mutateAsync(orderId)}><XCircle className="mr-1 h-4 w-4" /> Cancel</Button>
              </div>
              {shipShow && (
