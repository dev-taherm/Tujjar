    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('event_type', models.CharField(choices=[('page_view', 'Page View'), ('product_view', 'Product View'), ('add_to_cart', 'Add to Cart'), ('purchase', 'Purchase'), ('search', 'Search'), ('signup', 'Sign Up'), ('newsletter_subscribe', 'Newsletter Subscribe'), ('click', 'Click'), ('custom', 'Custom')], max_length=50)),
