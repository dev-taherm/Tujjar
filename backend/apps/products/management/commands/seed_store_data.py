...
PRODUCTS = [
    {
        ...
        "description": "Elegant leather-strap watch with Swiss movement and sapphire crystal glass.",
    },
    {
    ...
    },
    {
        ...
        "description": "Soft, breathable organic cotton tee available in 12 colors.",
    },
    {
    ...
    },
    {
        ...
        "description": "Set of 4 artisan-crafted ceramic mugs, each uniquely glazed.",
    },
    {
    ...
    },
    {
        ...
        "description": "Sleek 20L backpack with padded laptop sleeve and hidden anti-theft pocket.",
    },
    {
        ...
        "description": "Ultrasonic essential oil diffuser with 7 LED color lights and auto shut-off.",
    },
    {
        ...
        "description": "Large organic bamboo cutting board with juice groove and built-in handles.",
    },
    {
        ...
        "description": "Non-slip TPE yoga mat, 6mm thick, with alignment markings and carry strap.",
    },
    {
    ...
    },
    {
        ...
        "description": "Comfortable canvas slip-ons with memory foam insole. Perfect for everyday wear.",
    },
    {
        "title": "Journal & Pen Set",
        "price": "27.99",
        "category": "Stationery",
        "tags": ["journal", "pen", "stationery"],
        "description": "Linen-bound journal with 192 lined pages plus a matching brass-tipped rollerball pen.",
    },
    {
        ...
        "description": "25g protein per serving from pea, brown rice, and hemp. Chocolate flavor.",
    },
    {
        ...
        "description": "Three hand-poured soy wax candles: Lavender, Vanilla Bean, and Cedarwood.",
    },
    {
        ...
        "description": "Lightweight acetate frame sunglasses with UV400 polarized lenses.",
    },
    {
        ...
        "description": "Set of 5 color-coded latex-free resistance bands with carrying bag.",
    },
    {
    ...
    },
    {
        ...
        "description": "Stonewashed European linen throw, pre-shrunk, gets softer with every wash.",
    },
    {
...
class Command(BaseCommand):
    ...
    def _create_customers(self, store, org):
        ...
        for data in CUSTOMER_DATA:
            c = Customer.unscoped.create(
                ...
                is_verified=True,
                tags=random.sample(
                    ["loyal", "new", "returning", "vip", "wholesale"], k=random.randint(1, 2)
                ),
            )
    ...
    def _create_orders(self, store, org):
        ...
        for _i in range(25):
            ...
            payment_status = (
                "paid" if status in ("shipped", "delivered") else random.choice(["pending", "paid"])
            )
            ...
            stats.append(
                DailyStats(
                    ...
                    traffic_sources={
                        ...
                        "organic": random.randint(10, 40),
                        "social": random.randint(5, 20),
                        "referral": random.randint(0, 15),
                    },
                )
            )
